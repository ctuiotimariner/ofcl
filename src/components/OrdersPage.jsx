...
function OrdersPage({
  ...
  // 🔧 normalize sizes (this fixes 2X issue)
  ...
  try {
    ...
    alert("PO created successfully!")
      ...
      setSelectedOrder(newPO.order_group) // optional if you want
...
// ✅ auto update sell price based on REAL size pricing
useEffect(() => {
  if (!vendorUnitPrice) return

  const autoSellPrice = getAutoSellPrice(vendorUnitPrice, markupPercent)
  setSellPrice(autoSellPrice)
}, [markupPercent, vendorUnitPrice])

// ✅ min sell based on REAL size pricing
